  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabBar}>
        {/* Início */}
        <TouchableOpacity style={[styles.tabItem, segments[0] === 'home' && styles.activeTabItem]} onPress={() => router.replace('/home')}>
        ...
        {/* Solicitações */}
        <TouchableOpacity style={[styles.tabItem, segments[0] === 'requests' && styles.activeTabItem]} onPress={() => router.push('/Solicitacoes')}>
          <MaterialCommunityIcons name="clipboard-list-outline" size={24} color={segments[0] === 'requests' ? '#291F75' : '#FFFFFF'} />
          <Text style={[styles.tabText, segments[0] === 'requests' ? styles.tabActiveText : styles.tabInactiveText]}>Solicitações</Text>
        </TouchableOpacity>
        {/* Conta */}
        <TouchableOpacity style={[styles.tabItem, segments[0] === 'account' && styles.activeTabItem]} onPress={() => router.push('/Conta')}>
          <MaterialCommunityIcons name="account-outline" size={24} color={segments[0] === 'account' ? '#291F75' : '#FFFFFF'} />
          <Text style={[styles.tabText, segments[0] === 'account' ? styles.tabActiveText : styles.tabInactiveText]}>Conta</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
